...
class KiroCrewConfig:
    ...
    def create_provider_factory(self) -> Callable:
        ...
        # Fork: claude_code backend selection. "acp" (default) drives kiro-cli;
...
extra_env=_env,
                # Fork: provider=claude_code drives the dormant claude seam;
                # otherwise honor upstream's configured acp_backend (kiro/kas).
                acp_backend=_backend
                or _normalize_acp_backend(self.agent.acp_backend),
